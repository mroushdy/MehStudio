...
{ const mm=html.match(/window\.CADM=(\{.*?\});/s);
  ...
  if(mm){ const C=JSON.parse(mm[1]);
    ck('CAD keys: all 8 embedded bodies', ['BC_10HPL64','BC_12NDL76','BC_DE900TN','BC_DCX464','BC__DE610','BC_DE500','ES_12LW1400','BC_18PZB100'].every(k=>C[k]&&C[k].nv>1000&&C[k].nf>1000));
    ...
    ck('datasheet presets present (hpl10/ndl12/es12lw/pzb18/de610/de500)', /hpl10:\{name:'B&C 10HPL64/.test(html)&&/sd:320/.test(html)&&/ndl12:/.test(html)&&/es12lw:/.test(html)&&/pzb18:/.test(html)&&/de610:/.test(html)&&/de500:/.test(html));
